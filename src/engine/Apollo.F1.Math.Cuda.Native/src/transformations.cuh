...
F1_EXPORT void F1_API insert_column(void* pInput, void* pOutput, int iRows, int iColumns, double value);
...
F1_EXPORT void F1_API insert_row(void* pInput, void* pOutput, int iRows, int iColumns, double value);
